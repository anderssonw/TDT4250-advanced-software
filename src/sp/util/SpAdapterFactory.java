...
public class SpAdapterFactory extends AdapterFactoryImpl {
	...
	protected SpSwitch<Adapter> modelSwitch =
		new SpSwitch<Adapter>() {
			...
			@Override
			public Adapter caseStudyCohort(StudyCohort object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link sp.StudyCohort <em>Study Cohort</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createStudyCohortAdapter() {
		return null;
	}
